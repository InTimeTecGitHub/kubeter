    ...
    constructor(config: any) {
        ...
        con.addEventListener('drop', (e) => {
            ...
            Konva.Image.fromURL(itemURL, (image: Konva.Image) => {
                ...
                console.log(itemURL)
                if (itemURL == "http://localhost:3000/main_window/assets/ns.svg") {
                    ...
                    // 	}
                    // })).then(console.log)
                } else if (itemURL == "http://localhost:3000/main_window/assets/rs.svg" && namespace != undefined) {
                    ...
                    // 	}
                    // })).then(console.log);
                } else if (itemURL == "http://localhost:3000/main_window/assets/svc.svg" && namespace != undefined && replicaSet != undefined) {
                    image.setAttrs({
                ...
                else if (itemURL == "http://localhost:3000/main_window/assets/secret.svg" && namespace != undefined) {
                ...
                else if (itemURL == "http://localhost:3000/main_window/assets/cm.svg" && namespace != undefined) {
                    ...
                    // 	metadata: { name: "smurf" },
                    // })).then(console.log);
                } else if (itemURL == "http://localhost:3000/main_window/assets/ing.svg" && namespace != undefined) {
